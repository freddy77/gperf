 ...
 */
Output_C::Output_C (KeywordExt_List *head, const char *struct_decl,
  ...
  : Output (head, struct_decl, struct_decl_lineno, return_type,
            struct_tag, verbatim_declarations, verbatim_declarations_end,
            verbatim_declarations_lineno,
            verbatim_code, verbatim_code_end,
            verbatim_code_lineno, charset_dependent,
            total_keys, max_key_len, min_key_len,
...
void
Output_C::output_constants (struct Output_Constants& style) const
{
  style.output_start ();
...
/* Output_C gperf's ASCII-downcase table.  */
...
/* Output_C gperf's ASCII-case insensitive strcmp replacement.  */
...
/* Output_C gperf's ASCII-case insensitive strncmp replacement.  */
...
/* Output_C gperf's ASCII-case insensitive memcmp replacement.  */
...
void
Output_C::output_asso_values_index (int pos) const
{
...
void
Output_C::output_asso_values_ref (int pos) const
{
  printf ("asso_values[");
...
void
Output_C::output_hash_function () const
{
  /* Output_C the function's head.  */
  if (option[CPLUSPLUS])
    printf ("inline ");
...
void
Output_C::output_keylength_table () const
{
...
void
Output_C::output_string_pool () const
{
...
void
Output_C::output_keyword_table () const
{
...
void
Output_C::output_lookup_array () const
{
  if (option[DUP])
    {
...
void
Output_C::output_lookup_pools () const
{
  if (option[SWITCH])
    {
...
void
Output_C::output_lookup_tables () const
{
  if (option[SWITCH])
    {
...
/* Output_C a single switch case (including duplicates).  Advance list.  */
...
/* Output_C a total of size cases, grouped into num_switches switch statements,
...
void
Output_C::output_lookup_function_body (const Output_Compare& comparison) const
{
...
void
Output_C::output_lookup_function () const
{
  /* Output_C the function's head.  */
...
Output_C::output ()
{
  ...
  if (option[TYPE] && !option[NOTYPE]) /* Output_C type declaration now, reference it later on.... */
    {
